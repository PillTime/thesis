...
def topology(mobility):
    ...
    if mobility:
        ...
        sta1 = net.addStation('sta1', mac='00:00:00:00:00:01', position='10,10,0')
        sta2 = net.addStation('sta2', mac='00:00:00:00:00:02', position='50,10,0')
        sta3 = net.addStation('sta3', mac='00:00:00:00:00:03', position='90,10,0')
